...
FAST_LOOKUP: Dict[str, Tuple[str, List[str], List[str]]] = {
    ...
    "laptop":   ("electronics", ["laptop", "computer"],          ["لابتوب", "لاب توب"]),
    "mobile":   ("electronics", ["phone", "mobile"],             ["موبايل", "تليفون"]),
    "phone":    ("electronics", ["phone", "mobile"],             ["موبايل", "تليفون"]),
    # Arabic — phones (all common Egyptian spellings)
    "ايفون":    ("electronics", ["iphone", "apple"],             ["ايفون"]),
    "آيفون":    ("electronics", ["iphone", "apple"],             ["آيفون"]),
    "سامسونج":  ("electronics", ["samsung", "galaxy"],           ["سامسونج"]),
    "لابتوب":   ("electronics", ["laptop", "computer"],          ["لابتوب"]),
    "لاب توب":  ("electronics", ["laptop", "computer"],          ["لاب توب"]),
    "موبايل":   ("electronics", ["phone", "mobile"],             ["موبايل"]),
    "تليفون":   ("electronics", ["phone", "mobile"],             ["تليفون"]),
    "تيلفون":   ("electronics", ["phone", "mobile"],             ["تليفون"]),
    "تلفون":    ("electronics", ["phone", "mobile"],             ["تليفون"]),
    "هاتف":     ("electronics", ["phone", "mobile"],             ["هاتف"]),
    "جوال":     ("electronics", ["phone", "mobile"],             ["جوال"]),
    # Arabic — jewelry
    "خاتم":     ("jewelery",     ["ring", "gold"],               ["خاتم"]),
    "ذهب":      ("jewelery",     ["gold", "ring"],               ["ذهب"]),
    "مجوهرات":  ("jewelery",     ["jewelry", "ring"],            ["مجوهرات"]),
    # Arabic — clothing
    "جاكيت":    ("men's clothing", ["jacket", "coat"],           ["جاكيت"]),
    "قميص":     ("men's clothing", ["shirt"],                    ["قميص"]),
    "ملابس":    ("men's clothing", ["clothing", "shirt"],        ["ملابس"]),
    # Arabic — electronics general
    "كمبيوتر":  ("electronics", ["computer", "laptop"],          ["كمبيوتر"]),
    "شاشة":     ("electronics", ["monitor", "screen"],           ["شاشة"]),
    "سماعات":   ("electronics", ["headphones", "earbuds"],       ["سماعات"]),
}
...
def _check_fast_path(query: str) -> Optional[dict]:
    ...
    if normalized in FAST_LOOKUP:
        category, terms, synonyms = FAST_LOOKUP[normalized]
